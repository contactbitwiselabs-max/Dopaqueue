// We assume supabase.js UMD library is loaded via a <script> tag before this file.
...
const storageAdapter = (typeof chrome !== 'undefined' && chrome.storage && chrome.storage.local) ? {
