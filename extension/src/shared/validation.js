 ...
 * @param {boolean} options.requireVideoPlatform - Only allow video platforms
 * @param {boolean} options.allowAny - Allow any valid URL
 ...
 */
export function validateTags(tags, maxTags = 10) {
 ...
 */
export function validateOrThrow(value, validator, fieldName) {
